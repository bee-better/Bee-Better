...
* Επαναφορτιζόμενη μπαταρία (για ηλεκτρικό όχημα ή αυτοκίνητο), 12V 9AH
* 2 ανεμιστήρες, διαστάσεων: (120mm x 120mm), 12V
* Ψηφιακό θερμόμετρο  
* solar battery charger regulator (Μητρική πλακέτα κυκλώματος)
* 3 καλώδια σύνδεσης για το πάνελ 50cm
* Αισθητήρας θερμοκρασίας
* θερμοστάτης/συντονιστής, 12V
